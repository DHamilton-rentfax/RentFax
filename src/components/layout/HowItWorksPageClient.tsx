    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-20 text-center bg-gradient-to-b from-muted/20 to-background">
        ...
        <div className="flex justify-center gap-4">
          <Link href="/pricing">
            <Button className="px-8 py-3 text-lg bg-primary text-primary-foreground">
              View Plans
            </Button>
          </Link>
          <Link href="/contact">
            <Button className="px-8 py-3 text-lg border border-primary text-primary bg-transparent">
              Talk to Sales
            </Button>
          </Link>
        </div>
