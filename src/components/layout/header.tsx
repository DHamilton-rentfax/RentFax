...
import { Building2, Menu, X, LogOut, Settings, CreditCard, ShieldQuestion, BarChart2, User, Users, FileText, Bot, Hammer, CheckCircle, UploadCloud, Home } from 'lucide-react';
            ...
            <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
              ...
              <SheetContent side="right" className="w-full max-w-xs bg-card p-0">
                ...
                <nav className="flex flex-col space-y-4 p-4">
                  {[...navLinks, ...(isAdmin ? adminNavLinks.filter(l => isSuperAdmin || !['/admin/seed'].includes(l.href)) : [])].map((link) => (
                    <Link
                      key={link.href}
                      href={link.href}
                      onClick={() => setIsMobileMenuOpen(false)}
