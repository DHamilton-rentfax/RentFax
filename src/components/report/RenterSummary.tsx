    ...
    <div className="bg-white p-6 rounded-lg shadow-md">
      <div className="flex items-center space-x-6">
        ...
        <div>
          ...
          <div className="mt-2">
            <span
              className={`px-3 py-1 text-sm font-semibold rounded-full ${riskTier === "Low" ? "bg-green-100 text-green-800" : riskTier === "Moderate" ? "bg-yellow-100 text-yellow-800" : "bg-red-100 text-red-800"}`}
            >
              {riskTier} Risk
            </span>
          </div>
