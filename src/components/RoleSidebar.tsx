...
export default function RoleSidebar() {
  ...
  const menus: Record<string, { href: string; label: string; icon: any }[]> = {
    SUPER_ADMIN: [
      ...
      {
        href: "/admin/super-dashboard/team",
        label: "Team Invites",
        icon: Users,
      },
      {
      ...
      {
        href: "/admin/super-dashboard/critical-alerts",
        label: "Critical Alerts",
        icon: Shield,
      },
      { href: "/admin/departments/overview", label: "Department Overview", icon: BarChart },
      { href: "/admin/departments/insights", label: "AI Department Insights", icon: BarChart },
