  ...
  return (
    <div className="relative">
      <button
        ...
        className="relative rounded-full p-2 hover:bg-slate-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500"
      >
        <svg
          ...
          >
            ...
            {notifications.length === 0 ? (
              ...
              notifications.map((n) => (
                <div
                  key={n.id}
                  className={`p-3 border-b hover:bg-slate-50 ${n.read ? "opacity-60" : ""}`}
                >
