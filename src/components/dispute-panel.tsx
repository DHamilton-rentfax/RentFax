...
export default function DisputePanel({ incident: initialIncident }: DisputePanelProps) {
                ...
                {incident.status !== 'disputed' && (
                  <div className="border-t pt-4">
                      ...
                      <div className="space-y-2 mt-2">
                          ...
                          <Button onClick={handleDisputeSubmit} disabled={isSubmitting || !disputeMessage}>
