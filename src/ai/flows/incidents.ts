...
const CreateIncidentOutputSchema = z.object({id: z.string(), created: z.boolean()});
export type CreateIncidentOutput = z.infer<typeof CreateIncidentOutputSchema>;

export async function createIncident(input: CreateIncidentInput, auth?: FlowAuth): Promise<CreateIncidentOutput> {
