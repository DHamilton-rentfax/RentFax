...
export async function getCompanySettings(auth?: FlowAuth): Promise<CompanySettings | null> {
...
export async function updateCompanySettings(input: UpdateCompanySettingsInput, auth?: FlowAuth): Promise<void> {
