...
export const ADDON_CATALOG: Addon[] = [
  // Risk & AI Insights
  {
    ...
    details:
      "Helps landlords defend disputes, justify tenant denials, and prove due diligence with AI-driven explainability.",
    monthly: 29,
    annual: 290,
  ...
  },
  {
    ...
    details:
      "Perfect for multi-property managers. Tracks delinquency rates, fraud hotspots, and renter portfolio health.",
    monthly: 49,
    annual: 490,
    category: "📊 Risk & AI Insights",
  },
  {
    ...
    details:
      "Saves hours preparing dispute responses — formatted for small claims and renter hearings.",
    monthly: 19,
    annual: 190,
    category: "📊 Risk & AI Insights",
  },
  // Data & Uploads
  {
    ...
    details:
      "Increases CSV/manual import limits for agencies and larger fleets.",
    monthly: 14,
    annual: 140,
  ...
  },
  {
    ...
    details:
      "Strengthens renter profiles with external data points like bankruptcies, evictions, liens, and judgments.",
    monthly: 39,
    annual: 390,
    category: "📂 Data & Uploads",
  },
  // Team & Access
  {
    ...
    details:
      "Scale your operations team beyond your plan allowance. Each seat grants full user access with role controls.",
    monthly: 9,
    annual: 90,
  ...
  },
  {
    ...
    details:
      "Designed for franchises or multi-location rental groups. One parent dashboard, multiple child orgs.",
    monthly: 79,
    annual: 790,
    category: "👥 Team & Access",
  },
  // Compliance & Legal
  {
    ...
    details:
      "Meets compliance requirements for financial audits. Exportable to CSV/PDF.",
    monthly: 25,
    annual: 250,
  ...
  },
  {
    ...
    details:
      "Prepares correct jurisdiction forms automatically. Saves hours and reduces errors.",
    monthly: 49,
    annual: 490,
    category: "📑 Compliance & Legal",
  },
  {
    ...
    details:
      "Protects your business against improper tenant-screening lawsuits with compliance reminders and templates.",
    monthly: 29,
    annual: 290,
    category: "📑 Compliance & Legal",
  },
  // Collections & Financial
  {
    ...
    details:
      "Turns unpaid debt into recoverable assets automatically by pushing delinquent renters to partnered collections agencies.",
    monthly: 59,
    annual: 590,
  ...
  },
  {
    ...
    details:
      "Helps negotiate lower insurance premiums by sharing risk scoring reports with insurers or bonding companies.",
    monthly: 39,
    annual: 390,
    category: "💸 Collections & Financial",
  },
  {
    ...
    details:
      "Shared-risk pool protection — RentFAX covers part of your revenue loss on high-risk renters.",
    monthly: 99,
    annual: 990,
    category: "💸 Collections & Financial",
  },
  // Communication & Outreach
  {
    ...
    details:
      "Sends reminders for rent due, disputes, and approvals via SMS/email. Reduces disputes and enforces accountability.",
    monthly: 19,
    annual: 190,
  ...
  },
  {
    ...
    details:
      "Looks professional when sharing scores with tenants, partners, or investors.",
    monthly: 14,
    annual: 140,
    category: "📲 Communication & Outreach",
  },
