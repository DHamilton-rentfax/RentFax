...
describe('createIncident Server Action', () => {
    ...
    beforeEach(() => {
        ...
        (mockedAdminDB.collection as jest.Mock).mockReturnValue({ doc: () => mockRenterDocRef });
        (mockRenterDocRef.collection as jest.Mock).mockReturnValue(mockIncidentsCollectionRef);
        (mockIncidentsCollectionRef.doc as jest.Mock).mockReturnValue(mockIncidentDocRef);
    });
