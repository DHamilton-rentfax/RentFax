...
const SelectRenterStep = ({ next }) => (
  <div>
    <h2 className="text-xl font-bold mb-4">Step 1: Select Renter</h2>
...
const IncidentDetailsStep = ({ next, back }) => (
  <div>
    <h2 className="text-xl font-bold mb-4">Step 2: Incident Details</h2>
...
const EvidenceStep = ({ next, back }) => (
  <div>
    <h2 className="text-xl font-bold mb-4">Step 3: Upload Evidence</h2>
