...
export default function DashboardPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      {message && (
        <div
          className={`p-4 mb-4 rounded-md ${searchParams.get("payment_success") || isGeneratingReport ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
        >
          {message}
        </div>
      )}
      ...
      <div className="bg-slate-100 p-6 rounded-lg mb-6">
        ...
        <p className="text-slate-700 mb-4">
          Search for an existing report or generate a new one.
        </p>
        <form onSubmit={handleSearch}>
          ...
          <button
            ...
            className="bg-blue-500 text-white px-5 py-2 rounded-md font-medium"
          >
        ...
        {searchResult && (
          <div className="mt-6">
            {searchResult.found === false && (
              <div>
                <p className="text-slate-800 font-semibold">
                  No report found for this renter.
                </p>
                <p className="text-slate-600 mb-4">
                  We can run a new Deep Report for $20
                </p>
                <button
                  onClick={handlePurchaseDeepReport}
                  className="bg-amber-500 hover:bg-amber-600 text-white px-5 py-2 rounded-md font-medium"
                >
            ...
            {searchResult.status === "outdated" && (
              <div>
                <p className="text-slate-800 font-semibold">
                  An outdated report was found.
                </p>
                <p className="text-slate-600 mb-4">
                  For the most accurate information, we recommend generating a
                  new Deep Report for $20
                </p>
            ...
            {searchResult.status === "fresh" && (
              <div>
                ...
                <a
                  href={`/reports/${searchResult.report.id}`}
        ...
        {user ? (
          <div>
            ...
            <p className="text-slate-700">
              Deep Report Credits: {deepReportCredits}
            </p>
          </div>
        ) : (
      ...
      <div className="bg-slate-100 p-6 rounded-lg">
        <h2 className="text-xl font-semibold mb-2">
          Purchase Deep Report Credits
        </h2>
        <p className="text-slate-700 mb-4">
          Purchase credits to run deep reports on your applicants.
        </p>
        <button
