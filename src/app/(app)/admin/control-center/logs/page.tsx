          ...
          <tbody>
            {scheduledExports.map((scheduledExport) => (
              <tr key={scheduledExport.id}>
                <td className='border px-3 py-2'>{scheduledExport.cron}</td>
                <td className='border px-3 py-2'>{scheduledExport.emails.join(', ')}</td>
                <td className='border px-3 py-2'>{scheduledExport.lastRun ? new Date(scheduledExport.lastRun).toLocaleString() : 'Never'}</td>
              </tr>
            ))}
          </tbody>
        </table>
