      ...
      <div className="p-4 md:p-10 max-w-4xl mx-auto space-y-6">
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Import your existing renter data into RentFAX. The file must contain `name` and `email` columns. Other columns like `licenseNumber`, `licenseState`, `phone`, `dob`, and `notes` are optional.
                </CardDescription>
            </CardHeader>
            <CardContent>
                <RenterImporter />
