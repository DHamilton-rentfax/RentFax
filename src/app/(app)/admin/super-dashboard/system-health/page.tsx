...
export default function SystemHealthPage() {
      ...
      try {
        ...
        for (const chat of chatSnap.docs) {
          ...
          const firstUserMsg = messages.find(
            (m: any) => m.sender && !m.sender.includes("@"),
          );
          ...
          if (
            firstUserMsg &&
            firstAdminMsg &&
            firstUserMsg.createdAt &&
            firstAdminMsg.createdAt
          ) {
            const userTime = (firstUserMsg.createdAt as Timestamp)
              .toDate()
              .getTime();
            const adminTime = (firstAdminMsg.createdAt as Timestamp)
              .toDate()
              .getTime();
  ...
  if (stats.loading)
    return <p className="p-6 text-gray-500">Loading system health...</p>;
