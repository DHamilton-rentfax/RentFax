  ...
  return (
    <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <MetricCard title="Renter Clicks" value={stats.demo_role_selected_renter} />
            <MetricCard title="Company Clicks" value={stats.demo_role_selected_company} />
            <MetricCard title="Renter Reports" value={stats.demo_renter_report_viewed} />
            <MetricCard title="Company Dashboards" value={stats.demo_company_dashboard_viewed} />
        </div>
    </div>
  );
}
