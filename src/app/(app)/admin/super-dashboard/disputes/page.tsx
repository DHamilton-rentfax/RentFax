...
export default function DisputesPage() {
  ...
  async function createNewDispute(companyName: string) {
    ...
    const disputeRef = await addDoc(collection(db, "disputes"), {
      ...
      history: [
        { status: "NEW", date: new Date().toISOString(), changedBy: user.uid },
      ],
    });
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <div className="mb-6">
        <button
          onClick={() => createNewDispute("Sample Company Inc.")}
            ...
            <div key={d.id} className="flex items-center p-4 border-b">
              ...
              <div className="ml-4 flex-grow">
                ...
                <p className="text-sm text-gray-500">
                  Status:{" "}
                  <span className="font-medium text-red-600">{d.status}</span>
                </p>
              </div>
