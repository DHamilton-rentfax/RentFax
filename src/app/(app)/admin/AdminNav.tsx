...
const adminNavLinks = [
    ...
    { href: "/admin/risk-dashboard", label: "Risk Dashboard", icon: BarChart, roles: ["SUPER_ADMIN"] },
    ...
    { href: "/admin/readiness", label: "Readiness", icon: CheckCircle, roles: ["SUPER_ADMIN", "ADMIN"] },
