  ...
  if (!company)
    return (
      <div className="text-center py-20 text-gray-600">
        ...
        <br />
        <Link href="/client-company-dashboard/settings" className="text-blue-600 hover:underline">
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
        ...
        <Button
          onClick={() => (window.location.href = '/client-company-dashboard/settings')}
          variant="outline"
          size="sm"
        >
          Edit Profile
      ...
      <Card className="p-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <Link
            href="/client-company-dashboard/reports"
        ...
        <Button
          ...
          className="mt-4"
          onClick={() =>
            (window.location.href = '/client-company-dashboard/reports/new')
          }
        >
          + Add New Renter
        </Button>
      ...
      <Card className="p-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <Link
            href="/client-company-dashboard/disputes"
            className="text-blue-600 text-sm hover:underline"
          >
            View All
          </Link>
        ...
        <Button
          ...
          className="mt-4"
          onClick={() =>
            (window.location.href = '/client-company-dashboard/disputes/new')
          }
        >
          + File New Dispute
        </Button>
