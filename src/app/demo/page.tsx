    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 via-white to-gray-100">
      ...
      <main className="max-w-3xl w-full text-center p-10 mt-8 bg-white rounded-2xl shadow-lg">
        ...
        <p className="text-lg text-gray-600 mb-10">
          Experience RentFAX as a <strong>Renter</strong> or a{" "}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          ...
          <Link
            href="/demo/renter"
            onClick={() =>
              trackDemoEvent("demo_role_selected", { role: "RENTER" })
            }
          ...
          >
            ...
            <p className="text-gray-600">
              View your renter report, incident history, disputes, and fraud
              risk signals.
            </p>
          </Link>
          ...
          <Link
            href="/demo/company"
            onClick={() =>
              trackDemoEvent("demo_role_selected", { role: "COMPANY" })
            }
          ...
          >
            ...
            <p className="text-gray-600">
              Upload renters, view disputes, fraud alerts, and generate sample
              reports.
            </p>
          </Link>
        </div>
