...
export async function POST(req: Request) {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      line_items: [
        {
          price: "price_1PQ3dJAbK2S36ClWvISf4biy", // The price ID for the $20 deep report credit
          quantity: 1,
        },
      ],
      mode: "payment",
      ...
      metadata: {
        userId: user.uid,
        reportType: "deep_credit", // To identify this as a credit purchase in the webhook
      },
    });
